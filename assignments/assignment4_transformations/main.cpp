...
int main() {
	...
	librar::Transform transform[NUM_CUBES];
	transform[0].position = ew::Vec3(-0.5, 0.5, 0);
	transform[1].position = ew::Vec3(0.5, 0.5, 0);
	transform[2].position = ew::Vec3(-0.5, -0.5, 0);
	transform[3].position = ew::Vec3(0.5, -0.5, 0);
